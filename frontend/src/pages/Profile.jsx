...
const fetchProfile=async ()=>{
  try{
     const res=await axios.get(URL+"/api/auth/users/"+user._id)
...
const handleUserUpdate=async ()=>{
  setUpdated(false)
  try{
    const res=await axios.put(URL+"/api/auth/users/"+user._id,{username,email,password},{withCredentials:true})
...
const handleUserDelete=async()=>{
  try{
    const res=await axios.delete(URL+"/api/auth/users/"+user._id,{withCredentials:true})
    setUser(null)
    navigate("/")
    // console.log(res.data)
