...
const PostDetails = () => {
  ...
  const fetchPost=async()=>{
    try{
      const res= await axios.get(URL+"/api/auth/posts/"+postId)
  ...
  const handleDeletePost=async ()=>{
    ...
    try{
      const res=await axios.delete(URL+"/api/auth/posts/"+postId,{withCredentials:true})
      console.log(res.data)
      navigate("/")
  ...
  const fetchPostComments=async()=>{
    setLoader(true)
    try{
      const res=await axios.get(URL+"/api/auth/comments/post/"+postId)
  ...
  const postComment=async(e)=>{
    e.preventDefault()
    try{
      const res=await axios.post(URL+"/api/auth/comments/create",
